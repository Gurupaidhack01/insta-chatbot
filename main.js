...
client.on('messageCreate', (message) => {
    ...
    if(message.content.toLowerCase().includes('hi','hello','bye')){ 
        return message.chat.sendMessage('DESTROYER IS MY DEVELOPER CHECK OUT HIS CHANNEL :- https://instagram.com/ipx_king_yt_official');
    } else
...
client.login('itzx._.ipx', 'IPxKINGYT4422##');
